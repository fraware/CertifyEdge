...
use support::{
    ...
    runbook_spec_qc_release, with_source_commit,
};

#[test]
fn test_emit_certificate_from_handoff_manifest() {
...
#[test]
fn test_reject_handoff_trace_hash_mismatch() {
...
#[test]
fn test_reject_handoff_missing_property_id() {
...
#[test]
fn test_reject_handoff_wrong_to_component() {
