...
.PHONY: build test pcs-test runbook clean-checkout clean-checkout-certified fixtures release-run sync-pcs-core-rc check-pcs-core-rc check-trace emit-certificate verify-certificate install-cli substrate-test bazel-pcs-test
